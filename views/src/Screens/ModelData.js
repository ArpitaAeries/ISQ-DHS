      ...
      <form onSubmit={formSubmit}>
       ...
       <div className='formControls'>
          <div className='formControl custom-datepicker'>
            ...
            <input type='date' className='custom-datepicker-input' value={formValue.startDate} onChange={(e)=>setFormValue({...formValue,startDate:e.target.value})} />
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#4dd7ce" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
  ...
  <line x1="3" y1="10" x2="21" y2="10"></line>
          ...
          <div className='formControl custom-datepicker'>
            ...
            <input className='custom-datepicker-input' type='date' value={formValue.endDate} onChange={(e)=>setFormValue({...formValue,endDate:e.target.value})} />
            <div className="custom-calendar-icon">
